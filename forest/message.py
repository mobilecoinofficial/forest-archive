...
class StdioMessage(Message):
    ...
    def __init__(self, blob: dict) -> None:
        ...
        # {"envelope":{"source":"+***REMOVED***","sourceNumber":"+***REMOVED***","sourceUuid":"412e180d-c500-4c60-b370-14f6693d8ea7","sourceName":"sylv","sourceDevice":3,"timestamp":1637290589910,"dataMessage":{"timestamp":1637290589910,"message":"/ping","expiresInSeconds":0,"viewOnce":false}},"account":"+55527948360"}
        ...
        self.attachments: list[dict[str, str]] = msg.get("attachments", [])
        # "mentions":[{"name":"+55527948360","number":"+55527948360","uuid":"fc4457f0-c683-44fe-b887-fe3907d7762e","start":0,"length":1}
